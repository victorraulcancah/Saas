...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructureServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IHrCommissionService, HrCommissionService>();
        services.AddScoped<IHrContractService, HrContractService>();
        services.AddScoped<IHrVacationService, HrVacationService>();
        services.AddScoped<IHrShiftService, HrShiftService>();
        services.AddScoped<IOmsOrderService, OmsOrderService>();
        services.AddScoped<IOmsRoutingService, OmsRoutingService>();
        services.AddScoped<IOmsSalesChannelService, OmsSalesChannelService>();
        services.AddScoped<IWmsTaskService, WmsTaskService>();
        services.AddScoped<IWmsPickingService, WmsPickingService>();
        services.AddScoped<IWmsPackingService, WmsPackingService>();
        services.AddScoped<IWmsReplenishmentService, WmsReplenishmentService>();
        services.AddScoped<ITmsRouteService, TmsRouteService>();
        services.AddScoped<ITmsVehicleService, TmsVehicleService>();
        services.AddScoped<ITmsDeliveryService, TmsDeliveryService>();
        services.AddScoped<IPimProductContentService, PimProductContentService>();
        services.AddScoped<IPimMediaService, PimMediaService>();
        services.AddScoped<ISfaFieldOrderService, SfaFieldOrderService>();
        services.AddScoped<ISfaFieldVisitService, SfaFieldVisitService>();
        services.AddScoped<IHelpDeskTicketService, HelpDeskTicketService>();
        services.AddScoped<IHelpDeskMessageService, HelpDeskMessageService>();
        services.AddScoped<IRetailAnalyticsService, RetailAnalyticsService>();
        services.AddScoped<IRetailConversionService, RetailConversionService>();
        services.AddScoped<ILossPreventionService, LossPreventionService>();
        services.AddScoped<ILossShrinkageService, LossShrinkageService>();
        services.AddScoped<IBiMetricsService, BiMetricsService>();
        services.AddScoped<IBiDashboardService, BiDashboardService>();
