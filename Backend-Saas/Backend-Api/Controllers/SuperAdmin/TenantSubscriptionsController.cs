...
namespace Backend_Api
{
    ...
    public class TenantSubscriptionsController : ControllerBase
    {
        ...
        public async Task<IActionResult> AssignPlan(Guid tenantId, [FromBody] DTOs.SaasCatalog.AssignTenantPlanRequest request)
        {
        ...
        private static DTOs.SaasCatalog.TenantSubscriptionResponse MapSubscription(TenantSubscription subscription) => new(
            subscription.Id,
